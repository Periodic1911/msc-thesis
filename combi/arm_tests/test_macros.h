...
#-----------------------------------------------------------------------
# Tests for data processing ops
#-----------------------------------------------------------------------

#define TEST_IMM_OP( testnum, inst, result, val1, imm ) \
    TEST_CASE( testnum, r3, result, \
      ldr  r1, =val1; \
      inst r3, r1, imm; \
    )
...
#define TEST_RR_SHIFT_OP( testnum, inst, result, val1, val2, shift ) \
    TEST_CASE( testnum, r1, result, \
      ldr  r1, =val1; \
      ldr  r2, =val2; \
      inst r1, r1, r2, shift; \
...
#define TEST_MV_IMM_OP( testnum, inst, result, imm ) \
    TEST_CASE( testnum, r3, result, \
      inst r3, imm; \
    )

#define TEST_MV_OP( testnum, inst, result, val1 ) \
    TEST_CASE( testnum, r1, result, \
      ldr  r1, =val1; \
      inst r1, r1; \
    )

#define TEST_MV_SHIFT_OP( testnum, inst, result, val1, shift ) \
    TEST_CASE( testnum, r1, result, \
      ldr  r1, =val1; \
      inst r1, r1, shift; \
    )
...
#-----------------------------------------------------------------------
# Tests for tst-type ops (TST, TEQ, CMP, CMN)
#-----------------------------------------------------------------------

#define TEST_TST_IMM_OP( testnum, inst, cond, val1, imm ) \
    TEST_CASE_BRANCH( testnum, cond, \
      ldr  r1, =val1; \
      inst r1, imm; \
    )

#define TEST_TST_OP( testnum, inst, result, val1, val2 ) \
    TEST_CASE_BRANCH( testnum, result, \
      ldr  r1, =val1; \
      ldr  r2, =val2; \
      inst r1, r2; \
    )

#define TEST_TST_SHIFT_OP( testnum, inst, result, val1, val2, shift ) \
    TEST_CASE_BRANCH( testnum, result, \
      ldr  r1, =val1; \
      ldr  r2, =val2; \
      inst r1, r2, shift; \
